...
class AppointmentSearchAvailableController extends BaseOrganizationController
{
     ...
     * @clinic_id           A Clinic id.                                Example: 1
     * @x_weeks             Number of weeks on the future to search.    Example: 2
     * @specialist_id       A Specialist Id.                            Example: 16
     * @appointment_type_id An Appointment Type id.                     Example: 3
     * @time_requirement    A Time Requirement Id.                      Example: 4
