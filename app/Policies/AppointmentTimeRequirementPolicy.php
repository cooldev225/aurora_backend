...
class AppointmentTimeRequirementPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, AppointmentTimeRequirement $appointmentTimeRequirement)
    {
        return false;
    }
    ...
    {
        return $user->hasRole('organizationAdmin') && $appointmentTimeRequirement->organization_id == $user->organization->id;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, AppointmentTimeRequirement $appointmentTimeRequirement)
    {
        return false;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, AppointmentTimeRequirement $appointmentTimeRequirement)
    {
        return false;
    }
}
